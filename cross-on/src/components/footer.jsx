  ...
  return (
    ...
    <div className="container_footer">
      <div className="column">
        ...
        <hr></hr>
        <p className='footer-items'>Our mission is to provide a universal platform for the alumni to connect and collaborate and find solutions to real life problems
        </p>
